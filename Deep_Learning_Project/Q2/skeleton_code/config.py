...
class RNAConfig:
    ...
    # Data Path
    DATA_PATH: str = "../../To_remove/Data_Metadata/norm_data.txt" #NOTE: Only change this if you want to use a different path
    
    # Metadata is an Excel file
    METADATA_PATH: str = "../../To_remove/Data_Metadata/metadata.xlsx" #NOTE: Only change this if you want to use a different path
